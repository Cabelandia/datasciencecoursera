# Step 0: loading data into variables
...
test_activities$V1 <- factor(test_activities$V1,levels=activities$V1,labels=activities$V2)
train_activities$V1 <- factor(train_activities$V1,levels=activities$V1,labels=activities$V2)
